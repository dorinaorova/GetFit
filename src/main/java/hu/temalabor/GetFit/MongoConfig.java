...
//        return String ->{
//            counterRepository.save(new Counter("Activity", 0));
//            counterRepository.save(new Counter("Sport", 0));
//            counterRepository.save(new Counter("User", 0));
//            counterRepository.save(new Counter("Goal", 0));
//        };
//    }
}
